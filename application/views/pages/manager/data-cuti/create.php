<div class="container mx-auto px-4 py-8">
    <div class=" bg-white rounded-xl shadow-md overflow-hidden">
        <div class="p-8">
            ...
            <form class="space-y-6" action="<?= base_url('manager/data-cuti/store') ?>" method="post">
                <!-- Informasi Karyawan -->
                <div class="border-b border-gray-200 pb-6">
                    <h2 class="text-lg font-medium text-gray-900 mb-4">Informasi Karyawan</h2>
                    <!-- ID Karyawan -->
                ...
                <div class="pb-6">
                    <h2 class="text-lg font-medium text-gray-900 mb-4">Status Pengajuan</h2>
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div class="sm:col-span-3">
