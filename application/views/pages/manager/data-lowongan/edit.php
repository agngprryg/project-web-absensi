<div class="container mx-auto px-4 py-8">
    <div class=" bg-white rounded-xl shadow-md overflow-hidden">
        <div class="p-8">
            ...
            <form class="space-y-6" action="<?= base_url('manager/data-lowongan/update/' . $data_lowongan->id) ?>" method="post">
                <!-- Informasi Utama -->
                    ...
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <input
                                id="departemen"
                                name="departemen"
                                value="<?= $data_lowongan->departemen ?>"
                                required
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                        </div>
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <input
                                ...
                                value="<?= $data_lowongan->lokasi_penempatan ?>"
                                required
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                    ...
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <input
                                ...
                                id="tanggal_dibuka"
                                name="tanggal_dibuka"
                                value="<?= $data_lowongan->tanggal_dibuka ?>"
                                required
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                        </div>
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <input
                                ...
                                value="<?= $data_lowongan->tanggal_ditutup ?>"
                                required
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                        </div>
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <select
                                ...
                                required
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <option value="Full Time" <?= $data_lowongan->status_kerja == "Full Time" ? "selected" : "" ?>>Full Time</option>
                                <option value="Part Time" <?= $data_lowongan->status_kerja == "Part Time" ? "selected" : "" ?>>Part Time</option>
                                <option value="Freelance" <?= $data_lowongan->status_kerja == "Freelance" ? "selected" : "" ?>>Freelance</option>
                                <option value="Internship" <?= $data_lowongan->status_kerja == "Internship" ? "selected" : "" ?>>Internship</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <textarea
                                ...
                                required
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                placeholder="Jelaskan tanggung jawab dan deskripsi pekerjaan secara detail"><?= $data_lowongan->deskripsi ?></textarea>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <textarea
                                ...
                                required
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                placeholder="Sebutkan kualifikasi yang dibutuhkan"><?= $data_lowongan->kualifikasi ?></textarea>
